...
function muestra_ocultaB(id){
	...
	var a = document.getElementById("mas-menos-text6");
	var b = document.getElementById("contenido-todo6");
...
function muestra_ocultaH(id){
	...
	var a = document.getElementById("mas-menos-text7");
	var b = document.getElementById("contenido-todo7");
...
function muestra_ocultaFc(id){
	...
	var a = document.getElementById("mas-menos-text8");
	var b = document.getElementById("contenido-todo8");
...
function muestra_ocultaPmot(id){
	...
	var a = document.getElementById("mas-menos-text9");
	var b = document.getElementById("contenido-todo8");
...
function muestra_ocultaTH(id){
	...
	var a = document.getElementById("mas-menos-text11");
	var b = document.getElementById("contenido-todo11");
...
function muestra_ocultaRMAX(id){
	...
	var a = document.getElementById("mas-menos-text12");
	var b = document.getElementById("contenido-todo12");
...
function muestra_ocultaLC(id){
	...
	var a = document.getElementById("mas-menos-text13");
	var b = document.getElementById("contenido-todo13");
...
muestra_ocultaB("CalcularB");
muestra_ocultaH("CalcularH");
muestra_ocultaFc("CalcularFc");
muestra_ocultaPmot("CalcularPmot");
muestra_ocultaPmot("CalcularTH");
muestra_ocultaPmot("CalcularRMAX");
muestra_ocultaLC("CalcularLC");
}
